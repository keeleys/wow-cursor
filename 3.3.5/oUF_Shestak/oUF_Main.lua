...
local SetStyle = function(self, unit)
	...
	if unit == "player" then
		...
		if SettingsDB.mylevel ~= MAX_PLAYER_LEVEL and db.plugins_experience_bar == true then
			...
			self.Experience:SetWidth(4)
			self.Experience:SetOrientation("Vertical")
			self.Experience:SetPoint("TOPLEFT", self, "TOPLEFT", -25.5, 28)
		...
		if db.plugins_reputation_bar == true then
			...
			self.Reputation:SetWidth(4)
			self.Reputation:SetOrientation("Vertical")
			self.Reputation:SetPoint("TOPLEFT", self, "TOPLEFT", -15.3, 28)
		...
		if db.plugins_swing == true then
			...
			self.Swing:SetWidth(201)
			self.Swing:SetPoint("BOTTOMLEFT", "oUF_Player", "BOTTOMRIGHT", 16, 23)
	...
	if unit == "player" or unit == "target" then
		...
		if unit == "player" then
			...
			self.Buffs:SetPoint("TOPRIGHT", UIParent, "TOPRIGHT", -6, -20)
			...
			self.Enchant:SetPoint("TOPRIGHT", UIParent, "TOPRIGHT", -7, -76)
	...
	if db.unit_castbar == true and unit ~= "arenatarget" then
		...
		if unit == "focus" then
			...
			self.Castbar.Button:SetHeight(31)
			self.Castbar.Button:SetWidth(31)
